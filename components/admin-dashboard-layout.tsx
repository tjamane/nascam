...
export function AdminDashboardLayout({ children }: AdminDashboardLayoutProps) {
  ...
  const navigation = [
    ...
    { name: "Member Applications", href: "/admin/member-applications", icon: UserCheck, badge: "8" },
    { name: "Artist Profiles", href: "/admin/artist-profiles", icon: Users },
    { name: "Log Sheets", href: "/admin/log-sheets", icon: FileText },
    { name: "Licenses", href: "/admin/licenses", icon: FileCheck },
    { name: "Inspections", href: "/admin/inspections", icon: Search },
    { name: "Royalty Processing", href: "/admin/royalty-processing", icon: DollarSign },
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <header className="sticky top-0 z-40 flex h-16 items-center gap-4 border-b bg-background px-4 md:px-6 lg:hidden">
        <Sheet open={isMobileMenuOpen} onOpenChange={setIsMobileMenuOpen}>
          ...
          <SheetContent side="left" className="w-[240px] sm:w-[300px] pr-0">
            <div className="flex items-center gap-2 mb-8">
              ...
              <span className="font-bold text-lg">NASCAM Admin</span>
            </div>
        ...
        <div className="flex items-center gap-2">
          <Shield className="h-6 w-6 text-primary" />
          <span className="font-bold">NASCAM Admin</span>
        </div>
